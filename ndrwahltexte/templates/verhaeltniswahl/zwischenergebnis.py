...
(All result types containing "Zwischenergebnis")
"""
...
TEMPLATES = {
    ...
    "absatz1_abstand_plural": {
        ...
        "text": "{gewinner_pronomen} liegen damit vor {zweite_partei}. Für {zweite_partei} stimmten bisher {zweite_prozent} Prozent."
    },
